...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_APPEARANCE, 2064);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_I2S20, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_HW_NRF_I2S20, 1);
